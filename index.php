...
<link href='https://fonts.googleapis.com/css?family=Open+Sans|Open+Sans+Condensed:300' rel='stylesheet' type='text/css' />
        ...
        <meta property="og:url" content="<?PHP echo $pagina->localhost.$pagina->tg."/".$pagina->acao."/".$pagina->id;?>">
...
<link href="<?PHP echo $pagina->localhost;?>css/<?PHP
	echo (preg_match("/(cl3iente|retorno)/i",$canal->url) ? "mp2015c":"mp2015c")
	?>.css" rel="stylesheet" type="text/css" media="all" />
    
    
<script defer="defer" type="text/javascript" src="https://www.google.com/jsapi?key=ABQIAAAAbJ1kffsMyFnMaZ4PDuDS0BSC371tnk2SZdEOQM3zbULZ6eh5BRTxb1Bg-nAjYh2NAUyEpqMp0D6VTw"></script>
<script defer="defer" src="https://ajax.googleapis.com/ajax/libs/jquery/2.0.0/jquery.js" type="text/javascript"></script>
<script defer="defer" src="https://ajax.googleapis.com/ajax/libs/jqueryui/1.10.2/jquery-ui.min.js" type="text/javascript"></script>
<script defer="defer" src="<?PHP echo $pagina->localhost;?>proto.js/?sc=jquery.ui.selectmenu,jquery.validate,jquery.cycle.lite,jquery.maskedinput.min,jquery.isotope,jquery.carouFredSel-6.2.1,jquery.mousewheel-3.0.6.pack,jquery.fancybox.pack" type="text/javascript"></script>
<script defer="defer" src="<?PHP echo $pagina->localhost.filemtime("_scripts/_geral.php")?>_geral.js" type="text/javascript"></script>
<script defer="defer" src="<?PHP echo $pagina->localhost;?>_scripts/carrinho.js?t=<?=time()?>" type="text/javascript"></script>
...
<ul id="hipercategorias" class="sizeWide">
		<li class="hipercategoria"><a href="<?=$pagina->localhost?>Produtos/Categoria/Ofertas-que-Brilham/">Ofertas que Brilham</a>
		</li>
...
<?php /*?>		<li class="hipercategoria"><a href="<?=$pagina->localhost?>Produtos/Categoria/Linha-Empresarial/">Linha Empresarial</a>
		...
		<li class="hipercategoria"><a href="<?=$pagina->localhost?>Produtos/Categoria/Edicao-Limitada/">Linhas Especiais</a>
			<ul>
				<li><a href="<?=$pagina->localhost?>Produtos/Categoria/Celebrare/">Celebrare</a></li>
		...
		<li class="hipercategoria hipercategoriasDestaque"><a href="<?=$pagina->localhost?>Produtos/Categoria/Edicao-Limitada/">Outras Marcas</a>
			<ul>
				<li><a href="<?=$pagina->localhost?>Produtos/Fabricante/Bialetti/">Bialetti</a></li>
				<li><a href="<?=$pagina->localhost?>Produtos/Fabricante/EMSA/">EMSA</a></li>
				<li><a href="<?=$pagina->localhost?>Produtos/Fabricante/Riva/">Riva</a></li>
			</ul>
		</li>
	</ul>


	<? if($pagina->tg != 'Cliente' and $pagina->acao != 'Video'){?>
    <div id="banner-wrapper">
			...
			<?PHP
                  ...
                  while($res = $db->fetch()){
                     ...
                     foreach($obj->fotos as $foto){
						 echo '<a href="'.$obj->link.'"><img src="'.$pagina->img($foto['id'].($hotsite ? '/988/257/1':'/720/300/1')).'" title="'.$obj->referencia.'" alt="'.$obj->referencia.'" width="720" heigh="300" /></a>';
        ...
        <div id="bannerFixoCasamento"><a href="#" onclick="$.fancybox.open('#boxCadastroNewsletter')"><img src="<?=$pagina->localhost?>_imagens/banner_2015_noiva_newsletter.jpg" width="500" height="150"  alt=""/>
        </div>
        <div id="bannerFixoInstitucional"><a href="<?=$pagina->localhost?>Lista-de-Casamento"><img src="<?=$pagina->localhost?>_imagens/banner_2015_noiva_lista_casamento.jpg" width="500" height="150"  alt=""/></a>
        </div>
...
<div id="rodapeInner">
	...
	<a href="https://sslanalyzer.comodoca.com/?url=www.mesacor.com.br" target="_blank" class="compraseguraLink"><img src="<?PHP echo $pagina->ABSURL;?>_imagens/comodossl-trustlogo2.jpg" alt="comodossl-trustlogo2" width="103" height="71" /></a>
	</div>
