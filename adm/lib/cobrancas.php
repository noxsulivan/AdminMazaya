...
case "novo";
	...
	$formulario->fieldset('Valores - Preencha os valores a serem aplicados a todos os condôminos');
		...
		$formulario->fieldset->simples('Chamada de capital', 'chamada_capital');
...
default:
		...
		$admin->campos_listagem = array('Data de processamento' => "data_processamento",'Referência' => "referencia",'Valor Total' => "valor",'Vencimento' => "vencimento");
