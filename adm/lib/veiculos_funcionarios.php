...
case "novo";
	...
	$formulario->fieldset->simples('Funcionário', 'idfuncionarios');
...
break;
default:
	$admin->campos_listagem = array('Placa' => "placa",'Marca' => "marca",'Modelo' => "modelo",'Funcionário' => "funcionario->nome",'Data de cadastro' => "data_cadastro");
break; 
}
?>