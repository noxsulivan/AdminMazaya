...
default:
	...
	$admin->campos_listagem = array('Código' => "referencia",'Cliente' => "clientes->fantasia",'Representante' => "cadastros->nome",'Valor' => "valor",'Peso' => 'peso','Data' => "data",'Situação'=>'estagios->estagio');
