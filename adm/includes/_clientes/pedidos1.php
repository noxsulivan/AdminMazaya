...
<table cellpadding="3" cellspacing="3" style="padding:2.5% 5%; width:100%; margin:1.5% 2.5%; height:10cm;">
  <tbody>
    <tr>
    ...
    <tr>
      ...
      <td colspan="2"><strong>ENTREGA</strong></td>
    ...
    <tr>
      ...
      <td colspan="2"><?=($item->data_entrega == '00/00/0000' || $item->data_entrega == '00/00/000' ? "A DEFINIR" : str2upper($item->data_entrega)) ?></td>
