...
<h2>Chá de Panela - Cadastro</h2>
<?php /*?><h2>Cadastre sua lista de presentes do chá de panela e concorra a prêmios</h2>
<div class="content24">
...
<div class="clear espaco"></div>
							<div id="formulario">
								<form action="<?=$pagina->localhost.$canal->url?>Cadastro" method="post" id="formularioForm" onsubmit="return sendWindowForm('formulario' ,'formularioForm')">
									...
									<input name="tipo" type="hidden" value="cha" />
									<div class="formulario">
...
<?php */?>										<div class="campo">
											<label for="data_cha">Data do chá *</label>
											<input id="data_cha" name="data_cha" type="text" value="<?=ex_data($cliente->data_cha)?>" class="inputMedio" />
										</div>
										<div class="clear"></div>
									...
									<div class="formularioGrd">
										...
										<div class="campo">
											...
											<input id="cep" name="cep" type="text" value="<?=$cliente->cep;?>" class="inputMedio" />
										</div>
										<div class="campo">
										...
										<div class="campo">
											...
											<input id="endereco" name="endereco" type="text" value="<?=$cliente->endereco;?>" class="inputGrande" />
										</div>
										<div class="campo">
											<label for="numero">Número</label>
											<input id="numero" name="numero" type="text" value="<?=$cliente->numero;?>" class="inputPequeno" />
										</div>
										<div class="campo">
											<label for="complemento">Complemento</label>
											<input id="complemento" name="complemento" type="text" value="<?=$cliente->complemento;?>" class="inputPequeno" />
										</div>
										<div class="campo">
							...
							<script>
							<? //if($cliente->estados->id && $cliente->cidades->id) echo "consultaCEP.carregaCidades( ".$cliente->estados->id." , ".$cliente->cidades->id.")"; ?>
							<? //if($cliente->cidades->id && $cliente->bairros->id) echo "consultaCEP.carregaBairros( ".$cliente->cidades->id." , ".$cliente->bairros->id.")"; ?>
							</script>
<? break; ?>
<? } ?>
